...
import com.James.avroProto.Mail;
import com.James.avroProto.MailMessage;
...
public class Mailmain {
  public static class MailImpl implements Mail {
    ...
    public Utf8 send(MailMessage message) {
...
//    }
    ...
    message.setTo(new Utf8(("setTo")));
    message.setFrom(new Utf8("setFrom"));
    message.setBody(new Utf8("setBody"));
