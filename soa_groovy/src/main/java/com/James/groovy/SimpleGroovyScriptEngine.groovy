...
class SimpleGroovyScriptEngine {
  public static void main(String[] args) throws Exception {
    // GroovyScriptEngine的根路径，如果参数是字符串数组，说明有多个根路径
    GroovyScriptEngine engine = new GroovyScriptEngine("soa_groovy/src/main/java/com/James/groovy");
    ...
    //Object result1 = engine.run("GroovyTrans", binding);
    Object result1 = engine.run("groovyTrans", binding);

    if(result1!=null){
      System.out.println("转换结果"+JsonConvert.toJson(result1));
    }else{
